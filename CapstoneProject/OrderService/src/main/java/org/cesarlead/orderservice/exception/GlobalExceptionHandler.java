...
import org.cesarlead.orderservice.dto.ErrorResponseDTO;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseDTO> handleExternalServiceException(ExternalServiceException ex) {
        logger.warn("Fallo de comunicación con servicio externo: {}", ex.getMessage());
        ErrorResponseDTO error = new ErrorResponseDTO(
                "Uno de nuestros servicios no está disponible. Por favor intente más tarde.",
